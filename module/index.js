...
ModuleGenerator.prototype.askFor = function askFor() {
    ...
    mkUtils.addNamePrompt(this,prompts,'module');
...
ModuleGenerator.prototype.files = function files() {
    ...
    var module = mkUtils.getParentModule(path.join(this.dir,'..'));
    module.dependencies.modules.push(_.camelize(this.name));
    module.save();
    this.log.writeln(chalk.green(' updating') + ' %s',path.basename(module.file));

    mkUtils.processTemplates(this.name,this.dir,'module',this,null,null,module);
